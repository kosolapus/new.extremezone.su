<template>
  <section class="container small mb-4">
    ...
    <p>
      ...
      обеспечению безопасности персональных данных Extreme Zone (далее – Оператор).
    </p>
    <p>
    ...
    <p>
      ...
      <a href="https://extremezone.su">https://extremezone.su</a>
      .
    </p>
    ...
    <p>
      ...
      обеспечивающих их доступность в сети интернет по сетевому адресу https://extremezone.su;
    </p>
    <p>
    ...
    <p>
      ...
      совершаемые с персональными данными; Персональные данные – любая информация, относящаяся прямо или косвенно к
    ...
    <p>
      ...
      сервисов интернет-статистики (Яндекс Метрика и Гугл Аналитика и других). Вышеперечисленные данные далее по тексту
    ...
    <p>
      ...
      направив Оператору письмо на адрес электронной почты kosolapus@gmail.com с пометкой «Отказ от уведомлениях о новых
    ...
    <p>
      ...
      согласие с данной Политикой. Оператор обрабатывает обезличенные данные о Пользователе в случае, если это разрешено
    ...
    <p>
      ...
      направления Оператору уведомление на адрес электронной почты Оператора kosolapus@gmail.com с пометкой
    ...
    <p>
      ...
      электронный адрес Оператора kosolapus@gmail.com с пометкой «Отзыв согласия на обработку персональных данных».
    </p>
    ...
    <p>
      ...
      данных, обратившись к Оператору с помощью электронной почты kosolapus@gmail.com .
    </p>
    <p>
    ...
    <p>
      ...
      <nuxt-link to="policy">https://extremezone.su/policy</nuxt-link>
    </p>
  </section>
</template>
...
<script>
  export default {
    ...
    layout: 'inner',
    asyncData(ctx) {
      ctx.store.dispatch('setTitle', 'Условия обработки персональных данных')
    },
    head: () => ({
...
<style scoped>
  h3 {
    @apply text-2xl uppercase font-bold pb-4 pt-6;
  }
</style>
